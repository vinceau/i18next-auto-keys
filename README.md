...
// i18next-auto-keys.config.js
module.exports = {
  potTemplatePath: "locales/messages.pot",
  hashLength: 12,
  argMode: "named",
  topLevelKey: "common",
...
|--------|------|---------|-------------|
| `potTemplatePath` | `string` | `"i18n/messages.pot"` | Default path for POT template files |
...
| `projectId` | `string` | `"app 1.0"` | Project ID for POT file headers |
